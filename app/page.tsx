...
export default function Home() {
  ...
  const isCorrectNetwork = network === "goerli"
    ...
    <main className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      {isConnected && !isCorrectNetwork && (
        <Alert variant="destructive" className="mb-6">
          ...
          <AlertDescription>Please switch to Goerli testnet to interact with this DAO.</AlertDescription>
        </Alert>
      )}
      ...
      {!isConnected ? (
        ...
        <ProposalList walletAddress="0x1234...5678" />
      )}
    </main>
  )
}
